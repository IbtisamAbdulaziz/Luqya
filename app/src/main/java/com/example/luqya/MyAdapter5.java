...
public class MyAdapter5 extends RecyclerView.Adapter<MyAdapter5.MyViewHolder> {
    ...
    public MyAdapter5(Context context, List<DataClass> dataList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.event_item_admin, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        Button edit_event, Delete_Event;
